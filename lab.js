...
if ( temperature > 80 && rain === true){
  ...
  console.log("You should wear a tanktop and shorts")
  ...
  console.log ("You should wear a long sleeved shirt")
} else if (temperature < 60 && rain === true) {
  console.log ("You wear a jacket and carry an umbrella")
} else if (temperature < 60 && rain === false) {
  console.log("You should wear a whinter jacket")
} 
//CODE HERE
